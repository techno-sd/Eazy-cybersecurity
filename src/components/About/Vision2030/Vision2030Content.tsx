...
const Vision2030Content: React.FC<Vision2030Props> = ({ lang }) => {
  ...
  const content = {
    ...
    ar: {
      ...
      description: "تفخر إيزي للأمن السيبراني بالمساهمة في رؤية المملكة 2030 من خلال توفير حلول أمن سيبراني متطورة تحمي البنية التحتية الرقمية الوطنية وتمكّن التحول الرقمي عبر جميع القطاعات.",
      mainPoints: [
        {
          number: "٠١",
          title: "التحول الرقمي",
          text: "تمكين القطاعات الحكومية والخاصة بحلول رقمية آمنة متوافقة مع أهداف رؤية 2030.",
          icon: "bx bx-cloud-upload",
          color: "#0A4D8C"
        },
        {
          ...
          text: "حماية البنية التحتية الحيوية الوطنية من خلال الكشف المتقدم عن التهديدات ومراكز العمليات الأمنية.",
          icon: "bx bx-shield-alt-2",
          color: "#607EAC"
        },
        {
          ...
          text: "دعم ريادة الأعمال التقنية والشركات الناشئة بحلول سحابية آمنة وأدوات أمنية مدعومة بالذكاء الاصطناعي.",
          icon: "bx bx-bulb",
          color: "#0A4D8C"
        },
        {
          ...
          text: "المساهمة في تطوير الخبرات الوطنية من خلال برامج تدريب شاملة في الأمن السيبراني وبناء القدرات.",
          icon: "bx bx-user-check",
          color: "#607EAC"
        }
      ],
