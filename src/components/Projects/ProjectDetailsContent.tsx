          ...
          <div className="row justify-content-center">
            <div className="col-lg-9 col-md-12">
              <div className="services-details">
                <Image
                  src="/img/services-details/services-details1.jpg"
                  alt="Image"
                  width={900}
                  height={600}
                />
                ...
                <p>
                  ...
                  like Aldus PageMaker including versions of Lorem Ipsum. but
                  also leap into electronic
                </p>

                <h3>Pisa is changinga the world of cybersecurity</h3>
                ...
                <ul>
                  ...
                  <li>
                    <i className="bx bx-badge-check"></i>{" "}
                    <strong>Mitigating Cyber Security Risk</strong>
                  </li>
                  <li>
                    <i className="bx bx-badge-check"></i>{" "}
                    <strong>Protecting Malware</strong>
                  </li>
                  <li>
                    <i className="bx bx-badge-check"></i>{" "}
                    <strong>Defending Insider Threats</strong>
                  </li>
                  <li>
                    <i className="bx bx-badge-check"></i>{" "}
                    <strong>Securing Remote Workers</strong>
                  </li>
                  <li>
                    <i className="bx bx-badge-check"></i>{" "}
                    <strong>Testing Cyber Security</strong>
                  </li>
                </ul>
