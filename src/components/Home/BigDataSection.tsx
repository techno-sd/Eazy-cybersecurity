            ...
            <div className="approach-content" style={{ direction: isArabic ? 'rtl' : 'ltr', textAlign: isArabic ? 'right' : 'left' }}>
              ...
              <ul className="modern-list">
                <li style={{ marginBottom: '25px' }}>
                  <div style={{ flex: 1 }}>
                    <h3 style={{ marginBottom: '8px', fontSize: '18px', fontWeight: '600', color: '#0e0129' }}>{t.bigData.warehouse_title}</h3>
                    <p style={{ marginBottom: '0', fontSize: '14px', color: '#666' }}>{t.bigData.warehouse_desc}</p>
                  </div>
                </li>
                <li style={{ marginBottom: '25px' }}>
                  <div style={{ flex: 1 }}>
                    <h3 style={{ marginBottom: '8px', fontSize: '18px', fontWeight: '600', color: '#0e0129' }}>{t.bigData.dashboard_title}</h3>
                    <p style={{ marginBottom: '0', fontSize: '14px', color: '#666' }}>{t.bigData.dashboard_desc}</p>
                  </div>
                </li>
                <li style={{ marginBottom: '25px' }}>
                  <div style={{ flex: 1 }}>
                    <h3 style={{ marginBottom: '8px', fontSize: '18px', fontWeight: '600', color: '#0e0129' }}>{t.bigData.fraud_title}</h3>
                    <p style={{ marginBottom: '0', fontSize: '14px', color: '#666' }}>{t.bigData.fraud_desc}</p>
                  </div>
                </li>
                <li style={{ marginBottom: '0' }}>
                  <div style={{ flex: 1 }}>
                    <h3 style={{ marginBottom: '8px', fontSize: '18px', fontWeight: '600', color: '#0e0129' }}>{t.bigData.governance_title}</h3>
                    <p style={{ marginBottom: '0', fontSize: '14px', color: '#666' }}>{t.bigData.governance_desc}</p>
                  </div>
                </li>
              </ul>
            </div>
